...
(define-minor-mode extended-scala-mode ""
  ...
  (setq
   ...
   ar-block-closing-keywords-re (concat "[ \t]*[}\)][ \t]*" )
   ar-block-comment-prefix ar-block-comment-prefix
   ar-block-keywords (concat "[ \t]*" scala-indent:control-keywords-other-re)
   ar-extended-block-or-clause-re (concat "[ \t]*" scala-syntax:other-keywords-unsafe-re)
   ar-block-or-clause-re (concat "[ \t]*" scala-syntax:other-keywords-unsafe-re)
   ar-block-re (concat "[ \t]*" scala-indent:control-keywords-re)
   ...
   ar-class-re (concat "[ \t]*" "\\<\\(class\\|object\\|trait\\)\\>")
   ar-clause-re (concat "[ \t]*" scala-indent:control-keywords-other-re)
   ...
   ar-indent-offset scala-indent:step
   ...
   ar-minor-clause-re ar-scala-minor-clause-re
...
;;    ar-pylint-history ar-pylint-history
   ar-SomeMode-command-args ar-SomeMode-command-args
   ar-SomeMode-completions ar-SomeMode-completions
   ar-SomeMode-edit-version ar-SomeMode-edit-version
   ar-SomeMode-ffap-setup-code ar-SomeMode-ffap-setup-code
   ar-SomeMode-history ar-SomeMode-history
   ar-SomeMode-send-delay ar-SomeMode-send-delay
...
;;    ar-shell-extra-pythonpaths ar-shell-extra-pythonpaths
   ...
   comment-start ar-scala-comment-start
   comment-start-skip ar-scala-comment-start-skip
   ar-comment-start-re ar-scala-comment-start-re
   ar-comment-start-skip-re ar-scala-comment-start-skip-re
