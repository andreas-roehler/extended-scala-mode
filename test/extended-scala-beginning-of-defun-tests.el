...
(ert-deftest extended-scala-beginning-of-defun-test-S8VNtl ()
  (ar-test
      "def foo(p: Seq[String], q: Seq[Int]): Map[Int, String] =
  ???"
    'scala-mode
...
(ert-deftest extended-scala-beginning-of-defun-test-wweans ()
  (ar-test
...
(ert-deftest extended-scala-beginning-of-defun-test-YcRxyu ()
  (ar-test
      "type D4 = (Double, Double, Double, Int)
// val a: Seq[Double] =  List(1.0, 2.0, 3.4)
...
(ert-deftest extended-scala-beginning-of-defun-test-g2JtZe ()
  (ar-test
      "type D4 = (Double, Double, Double, Int)
// val a: Seq[Double] =  List(1.0, 2.0, 3.4)
...
(ert-deftest extended-scala-beginning-of-defun-test-d2KZi1 ()
  (ar-test
"object LargestTree {
...
(ert-deftest extended-scala-beginning-of-defun-test-bZp3fF ()
  (ar-test
"object LargestTree {
  def largestTree(a: Seq[List[Int]]): Seq[List[Int]] = {
    a.map{ k=>k.sortBy(k=>(-k))}.map{ k => k.take(3) }
...
(ert-deftest extended-scala-beginning-of-defun-test-CB1v8d ()
  (ar-test
      "// some comment
object LargestTree {
  def largestTree(a: Seq[List[Int]]): Seq[List[Int]] = {
...
(ert-deftest extended-scala-beginning-of-defun-test-9Au9zk ()
  (ar-test
      "// some comment
...
(ert-deftest extended-scala-beginning-of-defun-test-HjAcmj ()
  (ar-test
"// some comment
trait Pet {
...
(ert-deftest extended-scala-beginning-of-defun-test-yYjS3s ()
  (ar-test
"// some comment
trait Pet {
    def speak = println(\"Yo\")     // concrete implementation of a speak method
...
(ert-deftest extended-scala-beginning-of-defun-test-BZ3aQM ()
  (ar-test
"// some comment
def multiLeftFoldInt(a: Seq[Double]): (Double, Double, Double) = {
  val init: D4 = (Double.PositiveInfinity, Double.NegativeInfinity, 0.0, 0)
...
(ert-deftest extended-scala-beginning-of-defun-test-YNcqcU ()
  (ar-test
"// some comment
def multiLeftFoldInt(a: Seq[Double]): (Double, Double, Double) = {
  val init: D4 = (Double.PositiveInfinity, Double.NegativeInfinity, 0.0, 0)
...
(ert-deftest extended-scala-beginning-of-defun-test-y9WuQ6 ()
  (ar-test
"// some comment
def multiLeftFoldInt(a: Seq[Double]): (Double, Double, Double) = {
  val init: D4 = (Double.PositiveInfinity, Double.NegativeInfinity, 0.0, 0)
...
(ert-deftest extended-scala-beginning-of-defun-test-MHFSaE ()
  (ar-test
"// some comment
def multiLeftFoldInt(a: Seq[Double]): (Double, Double, Double) = {
  val init: D4 = (Double.PositiveInfinity, Double.NegativeInfinity, 0.0, 0)
...
(ert-deftest extended-scala-beginning-of-defun-test-eznI8K ()
  (ar-test
...
(ert-deftest extended-scala-beginning-of-defun-test-W1eux3 ()
  (ar-test
"import scala.annotation.tailrec
...
(provide 'extended-scala-beginning-of-defun-tests)
;;; extended-scala-beginning-of-defun-tests.el ends here
