;;; ar-emacs-scala3-forward-function-tests.el --- Test scala-mode navigation  -*- lexical-binding: t -*-
...
(defun ar-emacs-scala3-forward-def-test-ocYQwh ()
  ...
  (with-temp-buffer
    ...
    (assert (looking-back "???" (line-beginning-position)))
    ))

(defun ar-emacs-scala3-forward-def-test-O1YRXs ()
  ""
(interactive)
  (with-temp-buffer
(insert "def foo(p: Seq[String], q: Seq[Int]): Map[Int, String] = ???")
...
(defun ar-emacs-scala3-forward-def-test-S8VNtl ()
  ""
(interactive)
  (with-temp-buffer
      (insert "def foo(p: Seq[String], q: Seq[Int]): Map[Int, String] =
...
(defun ar-emacs-scala3-forward-def-test-XNuwtY ()
  ""
(interactive)
  (with-temp-buffer
      (insert "def foo(p: Seq[String], q: Seq[Int]): Map[Int, String] =
...
(defun ar-emacs-scala3-forward-def-test-yVEnBi ()
  ""
(interactive)
  (with-temp-buffer
...
")
    ...
    (goto-char (point-min))
    (ar-scala-forward-def)
    (assert (eq (char-before) ?}))
    ))

(defun ar-emacs-scala3-forward-def-test-wweans ()
  ""
(interactive)
  (with-temp-buffer
     (insert "def aktualisieren(p: D4, x: Double): D4 = p match { case (min, max, sum, length) =>
...
(defun ar-emacs-scala3-forward-def-test-uRKqXt ()
  ""
(interactive)
  (with-temp-buffer
      (insert "// some comment
...
(defun ar-emacs-scala3-forward-def-test-CqlQP0 ()
  ""
(interactive)
  (with-temp-buffer
      (insert "def aktualisieren(p: D4, x: Double): D4 = p match { case (min, max, sum, length) =>
...
(defun ar-emacs-scala3-forward-def-test-YcRxyu ()
  ""
  (interactive)
  (with-temp-buffer
    (insert "def aktualisieren(p: D4, x: Double): D4 = p match { case (min, max, sum, length) =>
...
(defun ar-emacs-scala3-forward-def-test-g2JtZe ()
  ""
(interactive)
  (with-temp-buffer
...
(defun ar-emacs-scala3-forward-def-test-d2KZi1 ()
  ""
(interactive)
  (with-temp-buffer
...
(defun ar-emacs-scala3-forward-def-test-bZp3fF ()
  ""
(interactive)
  (with-temp-buffer
    (insert "object LargestTree {
...
(defun ar-emacs-scala3-forward-def-or-class-test-CB1v8d ()
  ""
(interactive)
  (with-temp-buffer
    (insert "// some comment
...
(defun ar-emacs-scala3-forward-def-or-class-test-9Au9zk ()
  ""
(interactive)
  (with-temp-buffer
    (insert "// some comment
...
(defun ar-emacs-scala3-forward-def-or-class-test-8S6M05 ()
  ""
(interactive)
  (with-temp-buffer
      (insert "// some comment
...
(defun ar-emacs-scala3-forward-def-or-class-test-5vQnkh ()
  ""
(interactive)
  (with-temp-buffer
(insert "// some comment
...
(defun ar-emacs-scala3-forward-def-or-class-test-45R3LH ()
  ""
(interactive)
  (with-temp-buffer
(insert "// some comment
...
(defun ar-emacs-scala3-forward-def-or-class-test-nALcPi ()
  ""
  (interactive)
  (with-temp-buffer
    (insert "// some comment
...
")
    ...
    (ar-scala-forward-def-or-class)
    (back-to-indentation)
    (assert (looking-at "def comeToMaster"))))

(defun ar-emacs-scala3-forward-def-or-class-test-L3Ki5e ()
  ""
(interactive)
  (with-temp-buffer
...
")
    ...
    (goto-char (point-min))
    (ar-scala-forward-def-or-class)
    (assert (looking-back "expected)" (line-beginning-position)))))

(defun ar-emacs-scala3-forward-def-or-class-test-r8Auha ()
  ""
(interactive)
  (with-temp-buffer
    (insert "object LargestTree
...
(defun ar-emacs-scala3-forward-def-or-class-test-lGhLdK ()
  ""
(interactive)
  (with-temp-buffer
(insert "object LargestTree
...
(defun ar-emacs-scala3-forward-def-or-class-test-RZEaEC ()
   ""
   (interactive)
   (with-temp-buffer
     (insert "object LargestTree
...
(provide 'ar-emacs-scala3-forward-function-tests)
;;; ar-emacs-scala3-forward-function-tests.el ends here
